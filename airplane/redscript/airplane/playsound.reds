...
public func Airplane_QueueSound(sound: CName) -> Void {
...
@addMethod(PlayerPuppet)
public func Airplane_StopQueuedSound(sound: CName) -> Void {
    if !IsNameValid(sound) {
        //Log("Invalid Name: " + NameToString(sound));
        return;
    }
...
// the other
// @addMethod(PlayerPuppet)
// public func Airplane_PlaySound(sound: CName) -> Void {
//     if !IsNameValid(sound) {
//         Log("Invalid Name: " + NameToString(sound));
//         return;
//     }
...
// @addMethod(PlayerPuppet)
// public func Airplane_StopSound(sound: CName) -> Void {
//     if !IsNameValid(sound) {
//         Log("Invalid Name: " + NameToString(sound));
//         return;
//     }
