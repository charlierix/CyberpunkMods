...
public class OrbHackingBridge extends ScriptableSystem {
  ...
  // ============================================================
  // Lifecycle -- REQUIRED for ScriptableSystem instantiation
  // ============================================================
  // Without OnAttach/OnDetach, the engine does not instantiate
  // the ScriptableSystem, so GetScriptableSystemsContainer():Get()
  // returns nil. All working custom ScriptableSystems (Equipment-EX,
  // Codeware, BetterOpticalCamo) define these methods.
  // ============================================================

  public func OnAttach() -> Void {
    // Engine calls this when the ScriptableSystem is created.
    // Empty is fine -- the engine just needs the method to exist.
  }

  public func OnDetach() -> Void {
    // Engine calls this when the ScriptableSystem is destroyed.
    // Empty is fine -- the engine just needs the method to exist.
  }

  // ============================================================
  // Static accessor (REDscript-side, follows Equipment-EX pattern)
  // ============================================================
