// OrbHackingBridge -- CE2c: Quickhack Clearance Fix + Action Dump
...
public class OrbHackingBridge extends ScriptableSystem {
  ...
  public func ExecuteDeviceAction(
    ...
    // FIX: Use GetInteractionQuickHackClearance() instead of
    // GetInteractionClearance(). The old clearance returned
    // general interaction actions, not quickhack actions.
