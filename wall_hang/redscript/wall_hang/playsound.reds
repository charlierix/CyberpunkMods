...
public func WallHang_QueueSound(sound: CName) -> Void {
...
@addMethod(PlayerPuppet)
public func WallHang_StopQueuedSound(sound: CName) -> Void {
    if !IsNameValid(sound) {
        //Log("Invalid Name: " + NameToString(sound));
        return;
    }
...
// the other
// @addMethod(PlayerPuppet)
// public func WallHang_PlaySound(sound: CName) -> Void {
//     if !IsNameValid(sound) {
//         Log("Invalid Name: " + NameToString(sound));
//         return;
//     }
...
// @addMethod(PlayerPuppet)
// public func WallHang_StopSound(sound: CName) -> Void {
//     if !IsNameValid(sound) {
//         Log("Invalid Name: " + NameToString(sound));
//         return;
//     }
