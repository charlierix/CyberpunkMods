...
function DrawWindow_WallAttraction(isCloseRequested, vars_ui, window, const, player, player_arcade)
    ...
    Draw_Slider(wall_attraction.max_dist, vars_ui.style.slider)

    Draw_Label(wall_attraction.accel_label, vars_ui.style.colors)
    Draw_HelpButton(wall_attraction.accel_help, vars_ui.style.helpButton, window.left, window.top, vars_ui)
    Draw_Slider(wall_attraction.accel, vars_ui.style.slider)

    Draw_Label(wall_attraction.pow_label, vars_ui.style.colors)
    Draw_HelpButton(wall_attraction.pow_help, vars_ui.style.helpButton, window.left, window.top, vars_ui)
    Draw_Slider(wall_attraction.pow, vars_ui.style.slider)

    Draw_Label(wall_attraction.antigrav_label, vars_ui.style.colors)
    Draw_HelpButton(wall_attraction.antigrav_help, vars_ui.style.helpButton, window.left, window.top, vars_ui)
    Draw_Slider(wall_attraction.antigrav, vars_ui.style.slider)
