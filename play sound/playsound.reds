...
public func SoundTester_QueueSound(sound: CName) -> Void {
...
@addMethod(PlayerPuppet)
public func SoundTester_StopQueuedSound(sound: CName) -> Void {
    if !IsNameValid(sound) {
        Log("Invalid Name: " + NameToString(sound));
        return;
    }
...
// the other
@addMethod(PlayerPuppet)
public func SoundTester_PlaySound(sound: CName) -> Void {
    if !IsNameValid(sound) {
        Log("Invalid Name: " + NameToString(sound));
        return;
    }
...
@addMethod(PlayerPuppet)
public func SoundTester_StopSound(sound: CName) -> Void {
    if !IsNameValid(sound) {
        Log("Invalid Name: " + NameToString(sound));
        return;
    }
