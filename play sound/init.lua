...
-- Copy from the all list into this list (or look through adamsmasher dump for other candidates)
...
-- These are what I've found.  There are almost certainly more
function GetAllList()
    return
    {
        "dev_confession_booth_confessing",
...
-- some that maybe should have worked, but didn't
        -- "drone_defeated",
        -- "drone_destroyed",
        -- "drone_disable",
        -- "drone_enable",
        -- "hold_breath",
        -- "lcm_falling_wind_loop",
        -- "lcm_falling_wind_loop_end",
        -- "mute_tv_emitter",
        -- "Navigation",
        -- "OnBuyFail",
        -- "OnClose",
        ...
        -- "OnUnequip",
        -- "OnUse",
        -- "oxygen_critical_start",
        -- "oxygen_critical_stop",
        -- "Perk",
        -- "PhoneCallPopup",
        -- "Play_grenade",
        -- "Player_double_jump",
        -- "Player_falling_wind_loop",
        -- "PlaySFXEffector",
        -- "Quickmelee_guns",
        -- "Scripts:StopAndPlaySFXEffector:ActionOn",
        -- "Scripts:StopSFXEffector:ActionOn",
        -- "ShardPanel",
        -- "slow",
        -- "SmartGunRifle",
        -- "ST_Focus_Mode_Off_Set_State",
        -- "ST_Focus_Mode_On_Set_State",
        -- "StealthTrespassingPopup",
        -- "surface_from_dive",
        -- "surface_from_fast_dive",
        -- "TabButton",
        -- "unmute_tv_emitterr",
end