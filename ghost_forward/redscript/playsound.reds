...
public func GhostForward_QueueSound(sound: CName) -> Void {
...
@addMethod(PlayerPuppet)
public func GhostForward_StopQueuedSound(sound: CName) -> Void {
    if !IsNameValid(sound) {
        //Log("Invalid Name: " + NameToString(sound));
        return;
    }
...
// the other
// @addMethod(PlayerPuppet)
// public func GhostForward_PlaySound(sound: CName) -> Void {
//     if !IsNameValid(sound) {
//         Log("Invalid Name: " + NameToString(sound));
//         return;
//     }
...
// @addMethod(PlayerPuppet)
// public func GhostForward_StopSound(sound: CName) -> Void {
//     if !IsNameValid(sound) {
//         Log("Invalid Name: " + NameToString(sound));
//         return;
//     }
